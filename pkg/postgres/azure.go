...
func (azpg *azurepg) CreateUserRole(role, password string, iamAuthentication bool) (string, error) {
	returnedRole, err := azpg.pg.CreateUserRole(role, password, iamAuthentication)
	if err != nil {
		return "", err
	}
	if azpg.serverName == "" {
